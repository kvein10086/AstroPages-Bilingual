...
任何在 frontmatter 中设置 `gallery: true` 的文章，都会把正文里的图床照片汇入
[相册](/gallery) 页面，按文章聚合成一个相册，并链接回原文。把鼠标移到照片上
（或点开）即可看到从 EXIF 提取的图注、机型与拍摄参数。

下面这六帧来自 Wikimedia Commons 的知识共享照片，用来代替你自己的图床外链。

![秘鲁普诺，的的喀喀湖上的日出](https://upload.wikimedia.org/wikipedia/commons/3/35/Amanecer_en_el_lago_Titicaca%2C_Puno%2C_Per%C3%BA%2C_2015-08-01%2C_DD_01.JPG)

![越南顺化香江畔的天姥寺塔](https://upload.wikimedia.org/wikipedia/commons/8/88/Hue_Vietnam_Thien-Mu-Temple-and-Pagoda-03.jpg)

![横跨约克郡谷地的里布尔黑德高架桥](https://upload.wikimedia.org/wikipedia/commons/f/f2/2015_Ribblehead_Viaduct_1.jpg)

![尼泊尔一位额头绘彩的苦行僧](https://upload.wikimedia.org/wikipedia/commons/2/2b/Baba_in_Nepal.jpg)

![突尼斯街边摊上炸油饼的摊贩](https://upload.wikimedia.org/wikipedia/commons/a/a5/Beignet_maker.jpg)
...
- 里布尔黑德高架桥 — © [Kreuzschnabel](https://commons.wikimedia.org/wiki/File:2015_Ribblehead_Viaduct_1.jpg)，CC BY-SA 3.0
